...
struct R: Rswift.Validatable {
  ...
  struct file {
    ...
    /// Resource file `notoSansCJKkrMedium.otf`.
    static let notoSansCJKkrMediumOtf = Rswift.FileResource(bundle: R.hostingBundle, name: "notoSansCJKkrMedium", pathExtension: "otf")
    /// Resource file `notoSansCJKkrRegular.otf`.
    static let notoSansCJKkrRegularOtf = Rswift.FileResource(bundle: R.hostingBundle, name: "notoSansCJKkrRegular", pathExtension: "otf")
    ...
    /// `bundle.url(forResource: "notoSansCJKkrMedium", withExtension: "otf")`
    static func notoSansCJKkrMediumOtf(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.notoSansCJKkrMediumOtf
      return fileResource.bundle.url(forResource: fileResource)
    }

    /// `bundle.url(forResource: "notoSansCJKkrRegular", withExtension: "otf")`
  ...
  struct font: Rswift.Validatable {
    ...
    static func validate() throws {
      if R.font.notoSansCJKkrMedium(size: 42) == nil { throw Rswift.ValidationError(description:"[R.swift] Font 'NotoSansCJKkr-Medium' could not be loaded, is 'notoSansCJKkrMedium.otf' added to the UIAppFonts array in this targets Info.plist?") }
      if R.font.notoSansCJKkrRegular(size: 42) == nil { throw Rswift.ValidationError(description:"[R.swift] Font 'NotoSansCJKkr-Regular' could not be loaded, is 'notoSansCJKkrRegular.otf' added to the UIAppFonts array in this targets Info.plist?") }
    }
  ...
  struct image {
    ...
    /// Image `profile_img_large`.
    static let profile_img_large = Rswift.ImageResource(bundle: R.hostingBundle, name: "profile_img_large")
    /// Image `profile_img`.
    ...
    /// Image `user_card_match_btn`.
    static let user_card_match_btn = Rswift.ImageResource(bundle: R.hostingBundle, name: "user_card_match_btn")
    /// Image `woman`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "profile_img_large", bundle: ..., traitCollection: ...)`
    static func profile_img_large(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.profile_img_large, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "user_card_match_btn", bundle: ..., traitCollection: ...)`
    static func user_card_match_btn(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.user_card_match_btn, compatibleWith: traitCollection)
    }
    #endif
